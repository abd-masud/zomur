          ...
          <div className="admin-menu">
            <div className="logo crancy-sidebar-padding pd-right-0">
              <a className="crancy-logo" href="index.html">
                <img className="crancy-logo__main" src="img/logo.png" alt="#" />
                <img
            ...
            <div className="admin-menu__one crancy-sidebar-padding mg-top-20">
              ...
              <div className="menu-bar">
                <ul
                  id="CrancyMenu"
                  className="menu-bar__one crancy-dashboard-menu"
                >
                  <li className="active">
                    <a
                      className="collapsed"
            ...
            <div className="crancy-sidebar-padding pd-btm-40">
              ...
              <div
                ...
                style={{
                  ...
                  backgroundSize: "cover", // Optional: Ensures the background image covers the element
                              ...
                              <div className="crancy-header__single crancy-header__single--messages">
                                ...
                                <div className="crancy-dropdown crancy-dropdown__messages">
                                  ...
                                  <div className="crancy-dropdown__button">
                                    <a
                                      href="#"
                                      className="crancy-dropdown__view"
                                    >
                                      View All{" "}
                      ...
                      <div className="col-lg-4 col-12 mg-top-30">
                        <div className="crancy-progress-card">
                          <div
                            ...
                            data-value="0.115"
                          >
                            <b className="number crancy-color1">11.5%</b>
                          </div>
                          <div className="crancy-progress-card__content">
                            ...
                            <h4 className="crancy-progress-card__title">
                              <b className="count-animate">40,55K</b>
                            </h4>
                          </div>
                      ...
                      <div className="col-lg-4 col-12 mg-top-30">
                        <div className="crancy-progress-card">
                          <div
                            ...
                            data-value="0.775"
                          >
                            <b className="number crancy-color1">75.5%</b>
                          </div>
                          <div className="crancy-progress-card__content">
                            <div className="crancy-progress-card__history">
                      ...
                      <div className="col-lg-4 col-12 mg-top-30">
                        <div className="crancy-progress-card">
                          <div
                            ...
                            data-value="0.52"
                          >
                            <b className="number crancy-color1">52.5%</b>
                          </div>
                          <div className="crancy-progress-card__content">
                            <div className="crancy-progress-card__history">
                      ...
                      <div className="col-lg-5 col-md-6 col-12 crancy-sixth-two">
                        <div className="charts-main charts-home-two mg-top-30">
                          <div className="charts-main__heading mg-btm-20 charts-main__heading--v2">
                            <h4 className="charts-main__title">Sale Report</h4>
                            <div className="crancy-chart__dropdown">
                              <ul
                                className="nav nav-tabs crancy-dropdown__list"
                                id="nav-tab"
                            ...
                            <div className="tab-content" id="nav-tabContent">
                              ...
                              >
                                <div className="crancy-chart__inside crancy-chart__two">
                                  ...
                                  <span className="crancy-chart-groups__title">
                                    30%<span>Others</span>
                                  </span>
                                  <span className="crancy-chart-groups__title crancy-chart-groups__title--v2">
                                    20%<span>Google</span>
                                  </span>
                                  <span className="crancy-chart-groups__title crancy-chart-groups__title--v3">
                                    50%<span>Website</span>
                                  </span>
                                </div>
                              </div>
                            </div>
