              ...
              <div className="crancy-dsinner">
                <div className="row">
                  <div className="col-lg-4 col-12 mg-top-30">
                    <div className="crancy-ecom-card crancy-ecom-card__v2">
                      <div className="crancy-ecom-card__heading">
                        <div className="crancy-ecom-card__icon">
                          <h4 className="crancy-ecom-card__title">
                            Guide Views
                          </h4>
                        </div>
                      ...
                      <div className="crancy-ecom-card__content">
                        <div className="crancy-ecom-card__camount">
                          <div className="crancy-ecom-card__camount__inside">
                            <h3 className="crancy-ecom-card__amount">1.240</h3>
                  ...
                  <div className="col-lg-4 col-12 mg-top-30">
                    <div className="crancy-ecom-card crancy-ecom-card__v2">
                      <div className="crancy-ecom-card__heading">
                        <div className="crancy-ecom-card__icon">
                          <h4 className="crancy-ecom-card__title">Checklist</h4>
                        </div>
                        <div className="crancy-progress-card__authors">
                          <div className="crancy-tasksingle__group crancy-tasksingle__group--authors">
                            <Link href="/Marketing/">
                  ...
                  <div className="col-lg-4 col-12 mg-top-30">
                    <div className="crancy-ecom-card crancy-ecom-card__v2">
                      <div className="crancy-ecom-card__heading">
                        <div className="crancy-ecom-card__icon">
                          <h4 className="crancy-ecom-card__title">Hostpots</h4>
                        </div>
                        <div className="crancy-progress-card__authors">
                          <div className="crancy-tasksingle__group crancy-tasksingle__group--authors">
                            <Link href="/Marketing/">
          ...
          <div className="col-xxl-4 col-12 crancy-main__sidebar">
            <div className="crancy-sidebar mg-top-30">
              <div className="row">
                ...
                <div className="col-xxl-12 col-xl-6 col-12 crancy-sidebar__widget">
                  <div className="crancy-sidebar__single crancy-sidebar__single--bg">
                    <div className="crancy-total-view">
                      ...
                      <div className="crancy-chart__inside crancy-chart__total-view">
                        <canvas id="myChart_total_view"></canvas>
                      </div>{" "}
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xxl-12 col-xl-6 col-12 crancy-sidebar__widget">
                  <div className="crancy-sidebar__single crancy-sidebar__single--bordered">
                    <div className="crancy-traffic-list">
                      <div className="crancy-sidebar__heading">
                        <h4 className="crancy-sidebar__title">Top Traffic</h4>
                        <div
                          className="list-group crancy-new-list__tabs crancy-new-list__tabs--v2"
                          id="list-tab"
                          role="tablist"
                        >
                          <Link
                      ...
                      <div className="tab-content" id="nav-tabContent">
                        <div
                          ...
                          id="crancy-traffic-1"
                          role="tabpanel"
                          aria-labelledby="crancy-traffic-1"
                        >
                          <div className="crancy-traffic-list__list">
                            <div className="crancy-traffic-list__single mg-btm-20">
                              <div className="crancy-traffic-list__icon">
                              ...
                              <div className="crancy-traffic-list__progress">
                                ...
                                <div className="progress crancy-progressbar__single">
                                  <div
                                    className="progress-bar crancy-progressbar__bar crancy-color2__bg"
                                    role="progressbar"
                                    style={{ width: "95%" }}
                                    aria-valuenow={95}
                                    aria-valuemin={0}
                            ...
                            <div className="crancy-traffic-list__single">
                              <div className="crancy-traffic-list__icon">
